...
# Suporta execução a partir de toolbox-automation ou de toolbox-plugins
AUTOMATION_ROOT = Path(__file__).resolve().parent.parent
PLUGINS_ROOT = AUTOMATION_ROOT.parent / "toolbox-plugins"
if not PLUGINS_ROOT.exists():
    PLUGINS_ROOT = AUTOMATION_ROOT

PLUGINS_DIR = PLUGINS_ROOT / "plugins"
CATALOG_FILE = PLUGINS_ROOT / "catalog.json"
...
def audit_plugins():
    ...
    if issues_found:
        print(f"[AVISOS] {len(issues_found)} avisos detectados:")
